...
import { isBefore, startOfDay, endOfDay, startOfHour, endOfHour, parseISO } from 'date-fns';
import { AlreadyBookedError } from '../errors/AlreadyBookedError';
import { PastDateError } from '../errors/PastDateError';
import { Appointment } from '@prisma/client';
import { MAX_DAILY_APPOINTMENTS, MAX_HOURLY_APPOINTMENTS } from '../contants';


export class CreateAppointmentService {

  async createAppointment(inputData: AppointmentInput, dateObj: Date): Promise<Appointment> {
  ...
  private async validateAppointment(inputData: AppointmentInput, dateObj: Date): Promise<void> {
